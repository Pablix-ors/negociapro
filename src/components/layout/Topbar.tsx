      ...
      <header className="h-16 bg-white border-b border-slate-200 px-3 sm:px-4 lg:px-8 flex items-center justify-between sticky top-0 z-30 shadow-xs gap-2">
        ...
        <div className="flex-1 max-w-xs sm:max-w-md">
          <button
            ...
            className="w-full flex items-center justify-between px-2.5 sm:px-3.5 py-2 bg-slate-100/80 hover:bg-slate-200/60 text-slate-500 rounded-xl text-xs border border-slate-200 transition-all cursor-pointer group"
          >
